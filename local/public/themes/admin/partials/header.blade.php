    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse"
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand navbar-brand-center" href="../index.html">
          <img class="navbar-brand-logo navbar-brand-logo-normal" src="{{ asset('local/public/themes/admin/core/assets/images/logo.png') }}"
            title="Remark">
          <img class="navbar-brand-logo navbar-brand-logo-special" src="{{ asset('local/public/themes/admin/core/assets/images/logo-colored.png') }}"
            title="Remark">
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a class="thumbnail m-0" href="javascript:void(0)">
                            <img class="w-full" src="{{ asset('local/public/themes/admin/core/assets/photos/placeholder.png') }}" alt="..." />
                          </a>
                        </li>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link navbar-avatar" data-toggle="dropdown" href="#" aria-expanded="false"
                ...
                <span class="avatar avatar-online">
                  <img src="{{ asset('local/public/themes/admin/core/assets/portraits/5.jpg') }}" alt="...">
                  <i></i>
                </span>
              </a>
              <div class="dropdown-menu" role="menu">
